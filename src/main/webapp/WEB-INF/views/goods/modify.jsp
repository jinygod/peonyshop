...
<body>
	...
	<form:form action="${root }goods/modify_pro" method='post' modelAttribute="modifyGoodsBean" enctype="multipart/form-data">
		...
		<form:select path="goods_category" value='${goodsInfo.goods_category }'>카테고리<br/>
		...
		<form:textarea path="goods_content" value='${goodsInfo.goods_content }'/><br/>
		...
		<form:input type="file" path="upload_thumbnail" value='${goodsInfo.goods_thumbnail }'/><br/>
		</div>
